...
module Robot
  url='http://www.msktreningi.ru/company/index.php?page=1'
  path="./data/"
  file='msktrningi3.csv'
  ...
  email_record.method='css'
  email_record.key='a[href="mailto:[%C7%E0%F9%E8%F2%E0_%EE%F2_%F1%EF@%EC-%F0%EE%E1%EE%F2%EE%E2]"]'
  ...
  loader3=LoaderWatir.new #'Windows-1251'
  ...
  nodesblocks2.each do |node2|
    ...
    loader3.goto(starturi.join(next_href2).to_s)
